...
static int lua_vector2d_op_lt_y(lua_State *L)
{
    Vector2D* a = pd->lua->getArgObject(1, VECTOR_TYPE_NAME, NULL);
    Vector2D* b = pd->lua->getArgObject(2, VECTOR_TYPE_NAME, NULL);
...
static int lua_vector2d_op_lt(lua_State* L)
{
    return lua_vector2d_op_lt_x(L);
}
...
static const lua_reg vector2Dlib[] =
{
    ...
    { "__lt",		lua_vector2d_op_lt },
    { "ltX",		lua_vector2d_op_lt_x },
    { "ltY",		lua_vector2d_op_lt_y },
